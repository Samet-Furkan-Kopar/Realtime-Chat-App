...
//     // Şifreleme anahtarı
//     const encryptionKey = 'nyNm3TQx9c3JNlkgVf7y0wdMGZfNpxi4jIaM1M/CR9k=';
...
//     const cookieOptions = {
//         sameSite: 'Strict',
//         secure: true, // HTTPS üzerinde çalışıyorsa true olarak ayarlanmalıdır
//         httpOnly: true, // JavaScript'in cookie'ye erişmesini önlemek için
//         // diğer isteğe bağlı seçenekler buraya eklenebilir
//     };
//     const cookieValue = serialize("auth-session", encryptedData, cookieOptions);
//     res.setHeader('Set-Cookie', cookieValue);
// };
const createdUserOrLogin = async (data) => {
    const { name, picture, sub } = data;
    // console.log(data,"dataaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa")
    // console.log(name, "nameeeeeeeeee", picture, "picture", sub, "sub" );
...
async function getUserData(access_token) {
  ...
  const oauth = tryCatch(async (req, res) => {
    // console.log(req.query," ------------------------------------------------")
    const code = req.query.code;
// console.log(req)
    // console.log(code,"codeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee");
    try {
        const redirectURL = "http://localhost:8800/api/v1/auth/oauth"
       ...
       const obj = await createdUserOrLogin(data)
console.log(obj,"obj");
       obj.username !== null ? req.session.set('username', obj.username) : req.session.set('username', 'guest');
...
const googleLogin = tryCatch(async (req, res) => {
    ...
    console.log(authorizeUrl,"authorizeUrllllllllllllllllllllllllll")
//     const codeIndex = authorizeUrl.indexOf('code=');
//     const code = authorizeUrl.substring(codeIndex + 5);

//     console.log(code,"codeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee");
//     const redirectURLL = "http://localhost:8800"
