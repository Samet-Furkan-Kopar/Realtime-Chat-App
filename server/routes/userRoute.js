...
router.route("/user-register").post(FormData.uploadSettingImages,User.userRegister)
...
// router.route("/google-login").post(FormData.uploadSettingImages,User.googleLogin)
